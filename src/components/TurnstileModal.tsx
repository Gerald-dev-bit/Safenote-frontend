    ...
    if (widgetRef.current && window.turnstile && !widgetId.current) {
      try {
        widgetId.current = window.turnstile.render(widgetRef.current, {
          ...
          theme: "dark",
          size: "normal", // Ensures interactive checkbox mode
          appearance: "always", // Always show widget (no auto-hide)
        });
        // NO premature message change here - wait for user callback
      } catch (err) {
